...
垃圾收集器的图
![Alt text](./1406640547225.png)

- **Serial收集器**
 单线程，收集的时候停止用户线程，模式stop-the-world
 ![Alt text](./1406640601753.png)
